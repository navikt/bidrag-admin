...
class Rolle {
    ...
    fun erBidragspliktig(): Boolean = Rolletype.BP == type

    fun erBidragsmottaker(): Boolean = Rolletype.BM == type

    fun erBarn(): Boolean = Rolletype.BA == type

    fun erReellMotaker(): Boolean = Rolletype.RM == type
}
