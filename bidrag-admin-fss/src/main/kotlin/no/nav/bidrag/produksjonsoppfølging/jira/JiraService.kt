package no.nav.bidrag.produksjonsoppfølging.jira

import no.nav.bidrag.produksjonsoppfølging.jira.dto.CodeField
import no.nav.bidrag.produksjonsoppfølging.jira.dto.Comment
import no.nav.bidrag.produksjonsoppfølging.jira.dto.EditIssue
import no.nav.bidrag.produksjonsoppfølging.jira.dto.Issue
import no.nav.bidrag.produksjonsoppfølging.jira.dto.JiraSak
import no.nav.bidrag.produksjonsoppfølging.jira.dto.OpprettSakRequest
import no.nav.bidrag.produksjonsoppfølging.jira.dto.SearchResponse
import no.nav.bidrag.produksjonsoppfølging.jira.dto.User
...
class JiraService(
    ...
    fun opprettFagsystemsak(
        ...
        val request = OpprettSakRequest()
        request.fields["project"] = CodeField.withKey("FAGSYSTEM")
        request.fields["issuetype"] = CodeField.withId("13101")
        request.fields["customfield_20813"] = listOf(CodeField.withKey("CMDB-314134"))
        request.fields["customfield_20768"] = listOf(CodeField.withKey("CMDB-32629"))
        request.fields["customfield_20730"] = listOf(CodeField.withKey("CMDB-801"))
        request.fields["customfield_21414"] = CodeField.withId("25672")
        request.fields["customfield_21417"] = CodeField.withId("25684")
        request.fields["summary"] = summary
        request.fields["description"] = beskrivelse
        if (assignee != null) {
            request.fields["assignee"] = User.withName(assignee)
        }
